...
const EditPhoneModalContractor = ({ currentContractor, onContractorChange, info }) => {
  ...
  return (
    <>
      ...
      <Modal initialFocusRef={initialRef} isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent as="form" onSubmit={handleSubmit(editPhone)} backgroundColor="#020202">
...
export default EditPhoneModalContractor
