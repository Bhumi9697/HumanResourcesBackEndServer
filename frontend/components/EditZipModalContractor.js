...
const EditZipModalContractor = ({ currentContractor, onContractorChange, info }) => {
  ...
  return (
    <>
      ...
      <Modal initialFocusRef={initialRef} isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent as="form" onSubmit={handleSubmit(editZip)} backgroundColor="#020202">
...
export default EditZipModalContractor
