...
const EditStateModalContractor = ({ currentContractor, onContractorChange, info }) => {
  ...
  return (
    <>
      ...
      <Modal initialFocusRef={initialRef} isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent as="form" onSubmit={handleSubmit(editState)} backgroundColor="#020202">
...
export default EditStateModalContractor
