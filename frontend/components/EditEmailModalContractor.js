...
const EditEmailModalContractor = ({ currentContractor, onContractorChange, info }) => {
  ...
  return (
    <>
      ...
      <Modal initialFocusRef={initialRef} isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent as="form" onSubmit={handleSubmit(editEmail)} backgroundColor="#020202">
...
export default EditEmailModalContractor
